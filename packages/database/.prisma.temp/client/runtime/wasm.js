  ...
  const t = {
    ...
    r = (...n) => {
      ...
      if (
        ...
        const f = n.map((C) => (typeof C == "string" ? C : es(C))),
          v = `+${Date.now() - Rn}ms`;
        (Rn = Date.now()), a(o, ...f, v);
      }
    };
...
function pe(e, t) {
  const r = gs(t),
    ...
    i = new Proxy(e, {
      ...
      ownKeys(o) {
        const s = Hn(Reflect.ownKeys(o), r),
...
var Nr = Symbol();
function dt(e) {
  const t = [qs(e), z(Nr, () => e), z("$parent", () => e._appliedParent)],
...
function ua(e, t) {
  ...
  if (a instanceof G)
    if (
      ...
      const f = e.inputTypes.map(Vi).join(" | ");
      ...
      (this.logEmitter = r),
        ...
        (this.dataloader = new ir({
          ...
          singleLoader: async (n) => {
            const i =
                n.transaction?.kind === "itx" ? co(n.transaction) : void 0,
...
function go(e) {
  return e.map((t) => {
    const r = {};
    for (const n of Object.keys(t)) r[n] = ho(t[n]);
    return r;
  });
}
  ...
  Ba = {
    datasources: (e, { datasourceNames: t }) => {
      if (e) {
        ...
        for (const [r, n] of Object.entries(e)) {
          if (!t.includes(r)) {
            const i = Ke(r, t) || ` Available datasources: ${t.join(", ")}`;
            throw new F(
...
function Ua(e, t) {
  ...
  const r = t.map((i) => ({ value: i, distance: (0, Eo.default)(e, i) }));
...
function To(e) {
  class t {
    constructor(n) {
      ...
      const i = n?.adapter ? kr(n.adapter) : void 0,
        o = new St().on("error", () => {});

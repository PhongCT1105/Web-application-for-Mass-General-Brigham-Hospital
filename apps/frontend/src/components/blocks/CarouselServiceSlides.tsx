...
export const SecuritySlide = () => {
  return (
    <div className="SecurityRequest w-full h-[39rem] absolute overflow-hidden">
      <img
        className="BirthdayFlowersColors1 absolute inset-0 w-full h-[39rem] object-cover object-top"
        src={securityGuard}
        alt="Security Guard"
      />
...
export const FlowerSlide = () => {
  return (
    <div className="w-full h-[39rem] absolute overflow-hidden ">
      <img
        className="absolute inset-0 w-full brightness-75 h-[39rem] object-cover object-top"
        src={flowerPic}
        alt="Flower Picture"
      />
...
export const SanitationSlide = () => {
  return (
    <div className="w-full h-[39rem] absolute overflow-hidden">
      <img
        className="absolute inset-0 brightness-90 w-full h-[39rem] object-cover object-bottom"
        src={sanitation}
...
export const MedicationSlide = () => {
  return (
    <div className="w-full h-[39rem] absolute overflow-hidden ">
      <img
        className="absolute inset-0 w-full brightness-90 h-[39rem] object-cover object-top"
        src={medicationPic}
        alt="Flower Picture"
      />
      <div className="absolute inset-0 flex flex-col justify-end items-end p-8 mr-8 ml-8">
...
export const HeroSlide = () => {
  return (
    <div className="w-full h-[39rem] absolute overflow-hidden ">
      <img
        className="absolute inset-0 w-full brightness-75 h-[39rem] object-cover"
